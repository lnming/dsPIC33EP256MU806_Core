...
//
//  (c) Copyright 2016-2017, Fabian Kung Wai Lee, Selangor, MALAYSIA
//  All Rights Reserved  
//   
//////////////////////////////////////////////////////////////////////////////////////////////
//
...
float       gfOmegaLW = 0.0;            // Rotation velocity of left wheel in rotation/sec.
float       gfOmegaRW = 0.0;            // Rotation velocity of right wheel in rotation/sec.
...
void Proce_QuadEncoder_Driver(TASK_ATTRIBUTE *ptrTask)
{
    ...
    if (ptrTask->nTimer == 0)
    {
        switch (ptrTask->nState)
        {
            ...
            case 4: // State 4 - Perform secondary floating points calculations.  We try not to perform all floating
                    // points calculations within a single state, to prevent bandwidth overflow!  
