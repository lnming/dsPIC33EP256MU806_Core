...
#define __TIMER1COUNT           10000           // No. of Tcyc for Timer1 to expire (for 166.7us cycle).
...
#define	__TCLK_US               0.016129        // Processor clock = fosc/2 = fcyc for dsPIC33E.
                                                ...
                                                // Tcyc = (_TIMER1COUNT*(Tclk))= 166.67 usec
#define __TIMER1COUNT           10334           // No. of Tcyc for Timer1 to expire (for approximately 166.67us cycle).
#define	__SYSTEMTICK_US         166.67          // System_Tick = (_TIMER1COUNT*(Tclk))
*/
...
#define	__TCLK_US               0.015625        // Processor clock = fosc/2 = fcyc for dsPIC33E.
                                                ...
                                                // Tcyc = (_TIMER1COUNT*(Tclk))= 166.67 usec
#define __TIMER1COUNT           10667           // No. of Tcyc for Timer1 to expire (for approximately 166.67us cycle).
#define	__SYSTEMTICK_US         166.67          // System_Tick = (_TIMER1COUNT*(Tclk))
*/
...
#define __SCI_TXBUF_LENGTH      250	// SCI transmitt  buffer length in bytes.
...
extern INT16 gnRunTask;
extern INT16 gnTaskCount;
extern UINT32 gulClockTick;
