...
/// in use for other application.  This driver handles the low-level transmit and receive
/// operations. It assumes a single Master (i.e. this processor) and multiple slaves
/// environment.
/// Ver 0.91, 15 Nov 2015 - Basic version.
/// Ver 0.95, 17 Aug 2016 - Improved efficiency of multi-byte read.

/// I2C bus properties:
/// Baud rate = 200 kHz.
/// Mode: Single Master.
///
/// --- Example of usage: Transmitt operation ---
...
void Proce_I2C_Driver(TASK_ATTRIBUTE *ptrTask)
{
	...
	switch (ptrTask->nState)
	{
            case 0: // State 0 - Initialization of I2C2 module and set as Master mode.
                ...
                OSSetTaskContext(ptrTask, 53, 1000);     // Next state = 53, timer = 1000.
